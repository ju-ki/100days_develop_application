from engine.parser import Parser, JSONParser, CSVParser
...
def test_sample1_basic():
    ...
    assert CSVParser().parse(csv_text) == expected

def test_sample2_quoted_commas():
...
def test_sample3_multiline_quoted():
    csv_text = 'name,comment\nAlice,"This is a\nmultiline\ncomment."\nBob,"Another line."\n'
    expected = [
        ["name", "comment"],
        ["Alice", "This is a\nmultiline\ncomment."],
...
def test_sample4_escaped_quotes():
